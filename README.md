...
The framework is completed with a requirement specification template and methodology. <img align="right" src="diagrams/reqspec-tempate.png"> These capture SoI attributes and requirements, support coverage of strategic and stakeholder concerns, and enable ubiquitous traceability. <img align="right" src="diagrams/reqspec-methodology.png"> From this common basis, automated exchange of requirements is possible.
